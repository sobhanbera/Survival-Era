...
public class ModelLiveMatch {


    String uid,phone,email,
            tourID,tourImage,tourName,tourDate,tourTime,
    ...
    public ModelLiveMatch(String uid, String phone, String email, String tourID, String tourImage, String tourName, String tourDate, String tourTime, String tourWinningPrize, String tourPerKillPrize, String tourEntryFee, String tourVersion, String tourType, String tourMap, String tourCreatedTime, String tourVideoLink, String livematchVerified) {
        ...
        this.isVerified = livematchVerified;
    }

    public ModelLiveMatch() {
    }
    ...
    public void setLivematchVerified(String livematchVerified) {
        this.isVerified = livematchVerified;
    }
